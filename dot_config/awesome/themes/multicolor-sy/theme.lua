--[[
     ...
     Steve Yackey's Edits: Multicolor Awesome WM theme 2.0
     github.com/lcpz
...
local theme = {}
theme.confdir = os.getenv("HOME") .. "/.config/awesome/themes/multicolor-sy"
...
local mytextclock =
	wibox.widget.textclock(markup("#3ca4d8", "%A %d %B ") .. markup("#535f7a", ">") .. markup("#df3dad", " %l:%M%p "))
...
local cpu = lain.widget.cpu({
	settings = function()
		widget:set_markup(markup.fontfg(theme.font, "#df3dad", cpu_now.usage .. "% "))
	end,
})
...
theme.volume = lain.widget.alsa({
	settings = function()
		...
		widget:set_markup(markup.fontfg(theme.font, "#3ca4d8", volume_now.level .. "% "))
	end,
})
...
local netupinfo = lain.widget.net({
	settings = function()
		...
		widget:set_markup(markup.fontfg(theme.font, "#df3dad", net_now.sent .. " "))
...
theme.mpd = lain.widget.mpd({
	settings = function()
		...
		widget:set_markup(markup.fontfg(theme.font, "#df3dad", artist) .. markup.fontfg(theme.font, "#b2b2b2", title))
	end,
})
